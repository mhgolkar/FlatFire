...
- Flat Fire name space is "FFDB" (in master version) so you should care about this. for example, every time you want to call a function, it's necessary to call functions like this: "FFDB\functionX(input)"
</pre>
</details>
