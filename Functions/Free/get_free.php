...
//		 |_______________|  */
//	::: free_element parser :::
// function: get_free(id,field); returns an array or false if id is invalid
// inputs: id (name of element) id only for all values stored in this element or id and optionaly field or fieldss or id and single array of fields!
// but first connect to database using connect(database,user,pass)
// ____________________________________________
//

function get_free($in = null){
global $indb;
	//
